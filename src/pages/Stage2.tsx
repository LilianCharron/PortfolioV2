    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          >
            <FaShieldAlt className="text-sm" /> Rapport de Stage - 2ème Année
          </motion.div>
          ...
          >
            SÉCURITÉ INFRA <span className="text-transparent bg-clip-text bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-500">
              & RÉSEAU
            </span>
          </motion.h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <div className="px-4 py-1.5 rounded-lg glass border border-theme text-muted text-[8px] font-black uppercase tracking-widest flex items-center gap-2">
              <FaBuilding className="text-sky-500" /> Org:{' '}
              <span className="text-inherit">DE SANGOSSE</span>
            </div>
            <div className="px-4 py-1.5 rounded-lg glass border border-theme text-muted text-[8px] font-black uppercase tracking-widest flex items-center gap-2">
              <FaGraduationCap className="text-sky-500" /> Stage:{' '}
              <span className="text-inherit">2EME ANNÉE (SISR)</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          <InfoSummary icon={<FaShieldAlt />} label="Objectif" value="Sécurisation VPN & MFA" />
          <InfoSummary
            icon={<FaNetworkWired />}
            label="Architecture"
            value="Firewalling pfSense L3"
          />
        ...
        <div className="space-y-20 md:space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="text-muted text-lg leading-relaxed font-medium">
                Mise en place d'un environnement de laboratoire complet pour simuler et valider les
                changements critiques avant mise en production.
              </p>
              <div className="space-y-4">
                <TaskItem
                  title="Switching L2/L3"
                  desc="Configuration de VLANs, routage inter-VLAN et optimisation des flux réseaux sur matériel physique."
                />
                <TaskItem
                  title="pfSense Implementation"
                  desc="Déploiement et mise à jour de firewalls pfSense, correction de certificats et résolution de dépendances pkg."
                />
                <TaskItem
                  title="Network Simulation"
                  desc="Réplication du réseau existant pour tester des règles de pare-feu complexes sans impact sur la production."
                />
              </div>
            </motion.div>
            <div className="glass border border-theme rounded-[2.5rem] p-6 md:p-8 aspect-video relative overflow-hidden group">
              ...
              <FaServer
                className="absolute -bottom-10 -right-10 text-sky-500/5 group-hover:scale-110 transition-transform duration-1000"
                size={300}
              />
          ...
          >
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-muted text-lg mb-12 leading-relaxed">
                Intégration de la solution Duo MFA avec pfSense et OpenVPN pour répondre aux
                nouvelles exigences de cybersécurité de l'entreprise.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-8">
                <div className="space-y-4">
                  <h4 className="text-xs font-black uppercase tracking-widest text-warning">
                    Technologies Scalées
                  </h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-xs font-black uppercase tracking-widest text-sky-500">
                    Migration Strategy
                  </h4>
                  <p className="text-sm text-muted font-medium">
                    Étude et mise en place d'une transition douce via Radius pour les utilisateurs
          ...
          <div className="space-y-12 md:space-y-16">
            <h2 className="text-3xl md:text-4xl font-black text-center tracking-tighter uppercase opacity-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 text-left">
              <TimelineCard
                week="01"
                title="Environment"
                tasks={['AD Integration', 'L2/L3 Switching', 'pfSense Updates', 'Poste Deployment']}
              />
              <TimelineCard
                week="02"
                title="Security"
                tasks={['OpenVPN MFA', 'Duo Integration', 'Radius Setup', 'Migration Audit']}
              />
              <TimelineCard
                week="03"
                title="Infrastructure"
                tasks={['Hardware Sorting', 'LAPS Deployment', 'Firewall Analysis', 'Network Scan']}
              />
              <TimelineCard
                week="04"
                title="Deployment"
        ...
        >
          <div className="inline-block p-8 md:p-12 glass border border-theme rounded-[2rem] md:rounded-[2.5rem] relative group shadow-3xl">
            ...
            <h3 className="text-2xl font-black mb-4 uppercase tracking-tighter">Bilan du Stage</h3>
            <p className="text-muted italic max-w-2xl mx-auto font-medium">
              "Ce stage de deuxième année m'a permis de valider mes compétences en administration
              réseaux et cybersécurité au sein d'une infrastructure d'entreprise réelle."
            </p>
          </div>
        </motion.div>
      </div>
...
const TimelineCard = ({ week, title, tasks }: { week: string; title: string; tasks: string[] }) => (
  <div className="glass border border-theme rounded-3xl p-8 relative overflow-hidden hover:border-sky-500/30 transition-all group">
    <div className="absolute top-4 right-4 text-4xl font-black opacity-5 group-hover:opacity-10 transition-opacity">
      W{week}
    </div>
    <h4 className="text-sky-500 text-[10px] font-black uppercase tracking-widest mb-1">
      Week {week}
    </h4>
...
const Badge = ({ text }: { text: string }) => (
  <span className="px-3 py-1 glass border border-theme rounded-lg text-[9px] font-black uppercase tracking-widest text-muted">
    {text}
  </span>
);
...
const ToolCard = ({ icon, title, desc }: any) => (
  <div className="glass border border-theme rounded-[1.5rem] p-8 hover:bg-sky-500/5 transition-all duration-500 group relative overflow-hidden shadow-xl">
    <div className="flex items-center gap-4 mb-4 relative z-10">
      <div className="w-12 h-12 rounded-xl glass border border-theme flex items-center justify-center text-2xl group-hover:scale-110 group-hover:bg-sky-500/10 transition-all duration-700 shadow-lg">
        {icon}
      </div>
