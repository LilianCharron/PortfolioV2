        ...
        >
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, scale: 1 }}
                    className="glass border border-theme rounded-[2.5rem] p-8 md:p-12 mb-20 relative overflow-hidden shadow-3xl"
                >
                ...
                <div className="grid lg:grid-cols-12 gap-24 mb-40">
                    <div className="lg:col-span-12 space-y-12 mb-12">
                        <h2 className="text-4xl font-black tracking-tighter uppercase flex items-center gap-6">
                            <div className="w-12 h-1.5 bg-warning rounded-full shadow-lg" />
                            STRATEGY <span className="text-warning">&</span> DEPTH
                        </h2>
                    </div>

                    <div className="lg:col-span-6 space-y-10">
                        <div className="group glass border border-theme rounded-[1.5rem] p-8 hover:bg-warning/5 transition-all relative overflow-hidden shadow-2xl">
                ...
                <div className="grid lg:grid-cols-2 gap-16 mb-40">
                    <motion.div
                        whileHover={{ y: -6 }}
                        className="glass border border-theme rounded-[2.5rem] p-10 shadow-3xl overflow-hidden group"
                    >
                    ...
                    <motion.div
                        whileHover={{ y: -6 }}
                        className="relative bg-gradient-to-br from-sky-500/[0.03] to-transparent border border-theme rounded-[2.5rem] p-10 shadow-3xl overflow-hidden group"
                    >
                ...
                {/* Section Outils */}
                <div className="mb-24">
                    <h2 className="text-4xl font-black mb-16 text-center tracking-tighter uppercase italic opacity-20">Tools & Stack</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {/* Organisation */}
                        <div className="space-y-10">
                            <h3 className="text-sky-400 text-sm font-black uppercase tracking-[0.5rem] flex items-center gap-4">
                        ...
                        {/* Développement */}
                        <div className="space-y-10">
                            <h3 className="text-warning text-sm font-black uppercase tracking-[0.5rem] flex items-center gap-4">
                                <FaCode /> CODE_MODULES
                            </h3>
                            ...
                            <div className="glass border border-theme rounded-[1.5rem] p-8 font-bold italic text-muted text-base leading-relaxed shadow-inner">
                ...
                {/* Mission Details */}
                <div className="mb-40">
                    <h2 className="text-4xl font-black mb-16 tracking-tighter uppercase flex items-center gap-6">
                        <span className="text-warning">03.</span> ANALYSIS PATH
                    </h2>

                    <div className="space-y-24 relative before:absolute before:left-[-2px] before:top-4 before:bottom-4 before:w-[2px] before:bg-theme ml-4">
                        <div className="relative pl-12">
                            <div className="absolute left-[-9px] top-4 w-4 h-4 rounded-full bg-warning shadow-[0_0_20px_#fbbf24] z-10" />
                            <h3 className="text-2xl font-black mb-4 tracking-tight">Analyse Legacy (S1-S2)</h3>
                            <p className="text-muted text-base leading-relaxed font-medium mb-8 max-w-4xl text-justify">
                            ...
                            <div className="inline-flex flex-col gap-1.5 p-4 rounded-2xl glass border border-theme shadow-inner">
                                <span className="text-[8px] text-muted font-black uppercase tracking-widest">Inbound Tech</span>
                                <span className="font-bold text-base leading-none">C# WinForm Systems</span>
                            </div>
                        </div>

                        <div className="relative pl-12">
                            <div className="absolute left-[-9px] top-4 w-4 h-4 rounded-full bg-sky-500 shadow-[0_0_20px_#38bdf8] z-10" />
                            <h3 className="text-2xl font-black mb-4 tracking-tight flex items-center gap-4">
                        ...
                        <div className="relative pl-12">
                            ...
                            <h3 className="text-2xl font-black mb-4 tracking-tight">Full-Stack Dev (S4-S5)</h3>
                            <p className="text-muted text-base leading-relaxed font-medium mb-8 max-w-4xl text-justify">
                            ...
                            <div className="grid grid-cols-2 gap-4 max-w-2xl">
                                <div className="p-6 glass rounded-2xl border border-theme shadow-lg group hover:border-emerald-500/30 transition-all">
                                    <h4 className="text-emerald-500 text-[8px] font-black mb-3 uppercase tracking-[0.2em]">Front-end</h4>
                                    <p className="text-inherit opacity-70 font-bold text-sm">Modern Web Stack</p>
                                </div>
                                <div className="p-6 glass rounded-2xl border border-theme shadow-lg group hover:border-emerald-500/30 transition-all">
                                    <h4 className="text-emerald-500 text-[8px] font-black mb-3 uppercase tracking-[0.2em]">Back-end</h4>
                                    <p className="text-inherit opacity-70 font-bold text-sm">.NET Framework</p>
                                </div>
                            </div>
                        </div>
                    </div>
