    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          >
            <FaGraduationCap className="text-sm" /> Rapport de Stage - 1ère Année
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <div className="px-4 py-1.5 rounded-lg glass border border-theme text-muted text-[8px] font-black uppercase tracking-widest">
              Période : <span className="text-inherit">Mai – Juin 2025</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="columns-1 md:columns-2 gap-10 space-y-6 text-muted text-base leading-relaxed font-medium text-justify">
            <p>
              Je souhaite tout d’abord exprimer ma gratitude envers l’entreprise De Sangosse pour
              m’avoir accueilli au sein de ses équipes. Ce stage m'a permis de travailler dans un
              cadre idéal avec des professionnels pédagogues, ce qui sera déterminant pour la suite
              de mes études.
            </p>
            <p>
              Un grand merci à M. Jean-François Judit pour la présentation des équipes et du
              fonctionnement de la D.S.I. au sein du groupe.
            </p>
            <p>
              Je remercie particulièrement M. Cédric Duvignacq et M. Pierre-Antoine Chiaradia pour
              leur suivi quotidien, leur aide précieuse face aux blocages techniques, et
              l'organisation rigoureuse de ce projet sur cinq semaines.
            </p>
            <p>
              Enfin, merci à l'ensemble du personnel de De Sangosse pour leur accueil chaleureux et
              leur bienveillance constante.
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-24 mb-20 md:mb-40">
          <div className="lg:col-span-12 space-y-6 lg:space-y-12 mb-4 lg:mb-12">
            <h2 className="text-3xl md:text-4xl font-black tracking-tighter uppercase flex items-center gap-4 md:gap-6">
              ...
              CONTEXTE <span className="text-warning">&</span> OBJECTIFS
            </h2>
          </div>
          ...
          <div className="lg:col-span-6 space-y-10">
            <div className="group glass border border-theme rounded-[1.5rem] p-6 md:p-8 hover:bg-warning/5 transition-all relative overflow-hidden shadow-2xl">
              ...
              <p className="text-muted text-base leading-relaxed font-medium">
                Immersion au coeur de la D.S.I de De Sangosse. Une opportunité rare d'observer la
                gestion d'un parc informatique d'envergure internationale tout en participant
                activement à l'évolution du patrimoine applicatif.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-10">
            <div className="group glass border border-theme rounded-[1.5rem] p-6 md:p-8 hover:bg-warning/5 transition-all relative overflow-hidden shadow-2xl">
              ...
              <p className="text-muted text-base leading-relaxed font-medium">
                Modernisation d'une brique logicielle critique. Migration d'un environnement Legacy
                WinForm (C#) vers une architecture Web moderne distribuée, alignée sur les nouveaux
                standards Cloud de l'entreprise.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 mb-20 md:mb-40">
          ...
          >
            <h3 className="text-2xl font-black mb-6 tracking-tighter uppercase italic opacity-70 flex items-center gap-3">
              L'Entreprise{' '}
              <span className="text-warning text-[10px] not-italic opacity-30 tracking-widest">
                EST.1926
              </span>
            </h3>
            <p className="text-muted text-base leading-relaxed font-medium text-justify mb-8">
              Leader mondial des BioSolutions, De Sangosse déploie une ingénierie complexe pour une
              agriculture durable. Présence stratégique dans 40 pays avec un focus constant sur
              l'innovation.
            </p>
          ...
          >
            <FaBuilding
              className="absolute -bottom-16 -right-16 text-sky-500/5 group-hover:scale-110 transition-transform duration-1000"
              size={200}
            />
            <h3 className="text-2xl font-black mb-6 tracking-tighter uppercase italic opacity-70">
              Architecture D.S.I
            </h3>
            <p className="text-muted text-base leading-relaxed font-medium text-justify relative z-10">
              Support technologique transverse. Déploiement SAP, développements Agile internes et
              maintenance d'un réseau hybride complexe. La D.S.I est le moteur de la transformation
              digitale du groupe.
            </p>
        ...
        <div className="mb-20 md:mb-24">
          <h2 className="text-3xl md:text-4xl font-black mb-10 md:mb-16 text-center tracking-tighter uppercase italic opacity-20">
            Outils & Technologies
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-12">
            ...
            <div className="space-y-6 md:space-y-10">
              ...
              <div className="glass border border-theme rounded-[1.5rem] p-6 md:p-8 font-bold italic text-muted text-sm md:text-base leading-relaxed shadow-inner">
                "La transition vers le modèle MVC a permis une encapsulation totale des données,
                autorisant un déploiement web scalables et sécurisé."
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-16 md:space-y-24 relative before:absolute before:left-[-2px] before:top-4 before:bottom-4 before:w-[2px] before:bg-theme ml-1 md:ml-4">
            <div className="relative pl-8 md:pl-12">
              ...
              <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4 tracking-tight">
                Analyse Legacy (S1-S2)
              </h3>
              <p className="text-muted text-sm md:text-base leading-relaxed font-medium mb-6 md:mb-8 max-w-4xl text-justify">
                Déconstruction du socle WinForm existant. Identification des routines critiques et
                mapping des dépendances SQL pour une réécriture optimisée en environnement .NET
                Core.
              </p>
            ...
            <div className="relative pl-8 md:pl-12">
              ...
              <p className="text-muted text-sm md:text-base leading-relaxed font-medium mb-6 md:mb-8 max-w-4xl text-justify">
                Conceptualisation via Figma. Design system unifié respectant la charte graphique
                globale de De Sangosse tout en maximisant l'ergonomie mobile/tablet.
              </p>
            </div>
            ...
            <div className="relative pl-8 md:pl-12">
              ...
              <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4 tracking-tight">
                Full-Stack Dev (S4-S5)
              </h3>
              <p className="text-muted text-sm md:text-base leading-relaxed font-medium mb-6 md:mb-8 max-w-4xl text-justify">
                Implémentation du pattern MVC. Développement asynchrone pour une réactivité optimale
                et intégration de services RESTful pour la communication avec les bases de données
                SQL Server.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
                <div className="p-4 md:p-6 glass rounded-2xl border border-theme shadow-lg group hover:border-emerald-500/30 transition-all">
                  <h4 className="text-emerald-500 text-[8px] font-black mb-2 md:mb-3 uppercase tracking-[0.2em]">
                    Front-end
                  </h4>
                  <p className="text-inherit opacity-70 font-bold text-xs md:text-sm">
                    Modern Web Stack
                  </p>
                </div>
                <div className="p-4 md:p-6 glass rounded-2xl border border-theme shadow-lg group hover:border-emerald-500/30 transition-all">
        ...
        >
          ...
          <p className="text-muted text-xl leading-relaxed max-w-4xl mx-auto italic font-medium px-4">
            "Ce stage a validé ma capacité à transformer des systèmes complexes tout en maintenant
            une exigence de qualité industrielle au sein d'une D.S.I d'envergure."
          </p>
...
const ToolCard = ({ icon, title, desc }: any) => (
  <div className="glass border border-theme rounded-[1.5rem] p-8 hover:bg-warning/5 transition-all duration-500 group relative overflow-hidden shadow-xl">
    ...
    <div className="flex items-center gap-4 mb-4 relative z-10">
      <div className="w-12 h-12 rounded-xl glass border border-theme flex items-center justify-center text-2xl group-hover:scale-110 group-hover:bg-warning/10 transition-all duration-700 shadow-lg">
        {icon}
      </div>
...
const Metric = ({ icon, label, value }: any) => (
  <div className="flex flex-col items-center gap-3 group">
    <div className="text-warning text-xl group-hover:scale-125 transition-transform duration-700">
      {icon}
    </div>
    <div>
