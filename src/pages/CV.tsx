...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaBirthdayCake, FaCar, FaGlobeAmericas, FaDownload, FaBriefcase, FaGraduationCap, FaUser, FaMicrochip, FaDatabase, FaNetworkWired, FaTools } from 'react-icons/fa';
...
const CV: React.FC = () => {
    ...
    const keywords = ["SISR", "GPO", "DNS", "IPv6", "NAT", "SSH", "VPN", "RAID", "Backup", "LAN/WAN", "Proxmox", "Scripting"];
    ...
    return (
        ...
        >
            ...
            <div className="absolute left-10 top-1/2 -translate-y-1/2 hidden 2xl:flex flex-col gap-24 pointer-events-none z-10 opacity-20">
                <p className="rotate-90 text-[10px] font-black tracking-[0.5em] uppercase whitespace-nowrap">Dossier.Lcharron.sys</p>
                <div className="w-[1px] h-40 bg-theme-border mx-auto border-l border-theme rounded-full" />
                <p className="rotate-90 text-[10px] text-warning font-black tracking-[0.5em] uppercase whitespace-nowrap">Access: Granted</p>
            </div>
            <div className="absolute right-10 top-1/2 -translate-y-1/2 hidden 2xl:flex flex-col gap-24 pointer-events-none z-10 opacity-20">
                <p className="-rotate-90 text-[10px] font-black tracking-[0.5em] uppercase whitespace-nowrap">Auth.Encrypted.AES256</p>
                <div className="w-[1px] h-40 bg-theme-border mx-auto border-l border-theme rounded-full" />
                <p className="-rotate-90 text-[10px] text-sky-400 font-black tracking-[0.5em] uppercase whitespace-nowrap">Integrity: 100%</p>
            </div>
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <div className="flex flex-col items-center mb-24">
                    ...
                    >
                        <FaMicrochip className="text-sm animate-pulse" /> Personnel Profile v4.0
                    </motion.div>
                    ...
                    >
                        PARCOURS <span className="text-transparent bg-clip-text bg-gradient-to-br from-warning via-orange-500 to-sky-500">&</span> XP
                    </motion.h1>
                    ...
                    <div className="lg:col-span-4 space-y-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl font-black mb-10 tracking-tighter flex items-center gap-4">
                                <span className="w-10 h-1.5 bg-warning rounded-full shadow-[0_0_10px_#fbbf24]"></span> Profil
                            </h2>
                            <p className="text-muted leading-relaxed text-lg font-medium">
                                Volontaire, rigoureux et passionné par les systèmes d'information. Je m’efforce d’accomplir les missions confiées avec une précision chirurgicale. S'intègre naturellement dans des environnements techniques complexes.
                            </p>
                            <div className="mt-12 flex items-center gap-4 p-5 rounded-3xl bg-warning/5 border border-warning/10 shadow-inner">
                                ...
                                <span className="text-warning text-xs font-black tracking-[0.2em] uppercase">Active Engagement: High</span>
                            </div>
                        </motion.section>
                        ...
                        >
                            <h2 className="text-white text-xl font-black mb-8 tracking-tighter uppercase">Channels</h2>
                            <ul className="space-y-6">
                                <ContactItem icon={<FaPhone />} text="06 51 45 88 98" href="tel:+33651458898" />
                                <ContactItem icon={<FaEnvelope />} text="Lilian.charron@free.fr" href="mailto:Lilian.charron@free.fr" />
                                <ContactItem icon={<FaMapMarkerAlt />} text="47240 - Bon-Encontre" href="https://maps.app.goo.gl/51WzsVXbBLah2oyt8" />
                        ...
                        >
                            ...
                            <div className="space-y-6 relative z-10">
                                <ProjetItem title="Infrastructure Minecraft" desc="PaperMC, Linux Optimization, SQL Security" />
                    ...
                    <div className="lg:col-span-8 space-y-24">
                        ...
                        <section>
                            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                                ...
                                <h2 className="text-2xl md:text-3xl font-black tracking-tighter uppercase">Formation</h2>
                        ...
                        <section>
                            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                                ...
                                <h2 className="text-2xl md:text-3xl font-black tracking-tighter uppercase">Expérience</h2>
                                <div className="hidden md:block flex-grow h-[1px] bg-gradient-to-r from-theme-border to-transparent" />
                            </div>
                ...
                <section className="mt-24 w-full flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl px-4">
                        <SkillCard
                            ...
                            items={["Architecture IPv4/v6", "VLAN / ST / Routing", "PfSense / Firewalling", "DNS / DHCP Server"]}
                        />
                        <SkillCard
                            icon={<FaMicrochip />}
                            title="Systèmes"
                            items={["Active Directory / GPO", "PowerShell Automation", "Samba / Linux Distros", "Deployment (FOG)"]}
                        />
                        <SkillCard
                            icon={<FaTools />}
                            title="Labs & Virt"
                            items={["Proxmox / Hyper-V", "ZFS / RAID / Replication", "NextCloud / SSH / VPN", "MVC / Web Modern"]}
                        />
                    </div>
                </section>

                {/* Modern Downloads - Centered full width */}
                <div className="pt-16 pb-8 flex flex-col lg:flex-row gap-6 justify-center items-center w-full max-w-3xl mx-auto px-4">
                    <DownloadCard title="Print Ready (B&W)" file="/assets/cv/Cv-Noir-Blanc.pdf" />
                    <DownloadCard title="Interactive (Color)" file="/assets/cv/Cv-Couleur.pdf" />
                </div>
            </div>
            ...
            >
                ...
                <p className="text-muted text-[11px] font-black tracking-[0.6em] uppercase">End of Dossier - 2026</p>
            </motion.div>
        </div>
    );
};
...
// --- Static Data ---
const formations = [
    { title: "BTS SIO SISR", subtitle: "St-John Perse (Pau)", date: "2024 - 2026", desc: "Solutions d’infrastructure, systèmes et réseaux. Expertises en administration et sécurisation." },
    { title: "Bac STI2D (SIN)", subtitle: "Lycée de Baudre (Agen)", date: "2021 - 2024", desc: "Option Systèmes d'Information et Numérique. Focus hardware et fondamentaux info." },
    { title: "Formation Continue", subtitle: "OpenClassrooms", date: "Present", desc: "Veille techno active et perfectionnement autodidacte sur les nouveaux standards." }
];

const experiences = [
    { title: "Stage Informatique", subtitle: "DE SANGOSSE", date: "Mai - Juin 2025", desc: "Migration WinForm vers Web Modern (MVC). Gestion flux CSV complexes.", isSpecial: true },
    { title: "Jobs d'été Intérim", subtitle: "Secteur Agro", date: "2021 - 2025", desc: "Préparateur, ripeur, manutention. Rigueur extrême et endurance physique." },
    { title: "Animation Colonie", subtitle: "Centres de Vacances", date: "2022", desc: "Gestion de groupes (8-12 ans), animation et sécurité." }
];
...
const ContactItem = ({ icon, text, href }: any) => (
    <li className="flex items-center gap-4 md:gap-6 group">
        <div className="w-10 h-10 md:w-12 md:h-12 flex-shrink-0 flex items-center justify-center rounded-xl md:rounded-2xl group-hover:border-warning group-hover:shadow-[0_0_20px_rgba(251,191,36,0.1)] transition-all duration-500 glass relative overflow-hidden">
        ...
        <div className="flex flex-col min-w-0 overflow-hidden">
            {href ? (
                <a href={href} className="font-bold text-sm md:text-base tracking-tight hover:text-warning transition-colors truncate">{text}</a>
            ) : (
                <span className="font-bold text-sm md:text-base tracking-tight truncate">{text}</span>
            )}
            <span className="text-[8px] text-muted font-black tracking-widest uppercase mt-0.5">Status: Verified</span>
        </div>
    </li>
);
...
const ProjetItem = ({ title, desc }: any) => (
    <div className="p-5 rounded-3xl glass hover:border-warning/40 transition-all duration-500 group shadow-inner">
        <h4 className="font-black text-sm mb-1.5 group-hover:text-warning transition-colors tracking-tight">{title}</h4>
        <p className="text-muted text-[10px] font-bold tracking-tight leading-relaxed">{desc}</p>
    </div>
);
const TimelineItem = ({ title, subtitle, date, desc, isSpecial }: any) => (
    <motion.div
    ...
    >
        ...
        <div className="glass rounded-[1rem] md:rounded-[1.5rem] p-4 md:p-6 hover:bg-warning/5 transition-all duration-700 group-hover:-translate-y-2 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-2 mb-3">
                <span className="text-warning text-[8px] md:text-[9px] font-black tracking-[0.4em] uppercase opacity-70">{date}</span>
                {isSpecial && <span className="px-3 py-1 bg-warning/20 text-warning text-[8px] font-black uppercase rounded-full tracking-widest border border-warning/10 shadow-lg">Premium Entry</span>}
            </div>
            <h3 className="text-lg md:text-xl font-black mb-1 tracking-tighter leading-tight">{title}</h3>
            <h4 className="text-sky-400 font-black text-[9px] md:text-[10px] uppercase tracking-[0.2em] mb-4 md:mb-5 opacity-50">{subtitle}</h4>
...
const SkillCard = ({ icon, title, items }: any) => (
    ...
    >
        <div className="absolute -right-4 -top-4 text-6xl opacity-10 transition-transform duration-1000 group-hover:rotate-12 group-hover:scale-110">{icon}</div>
        ...
        <ul className="space-y-3">
            {items.map((item: string, i: number) => (
                <li key={i} className="text-muted text-[11px] font-bold flex gap-3 group-hover:text-inherit transition-colors tracking-tight">
...
const DownloadCard = ({ title, file }: any) => (
    <motion.a
    ...
    >
        ...
        <div className="flex flex-col text-left">
            ...
            <span className="text-muted text-[8px] font-black tracking-widest uppercase">Format: PDF / Secure</span>
        </div>
    </motion.a>
);
