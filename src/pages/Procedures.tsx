...
const Procedures: React.FC = () => {
  ...
  return (
    <div className="pt-20 pb-24 px-4 min-h-screen bg-page relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <FaCode className="animate-pulse" /> MON CARNET DE BORD TECHNIQUE
            </motion.div>
            ...
            <p className="text-muted text-lg leading-relaxed font-medium max-w-3xl">
              Bienvenue dans ma base de connaissances. Je centralise ici mes guides et procédures opérationnelles pour garder une trace claire de mes configurations système et réseau.
            </p>
      ...
      {/* Procedures List with Alt Background */}
...
const ProcedureCard: React.FC<{ procedure: Procedure; index: number }> = ({ procedure, index }) => {
  ...
  return (
    ...
    >
      {/* Category Badge */}
      <div
        className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r ${getCategoryColor(procedure.category)} border text-xs font-black uppercase tracking-wider mb-4`}
      >
      ...
      {/* Description */}
      <p className="text-muted text-sm leading-relaxed mb-6">{procedure.description}</p>
      ...
      <div className="flex flex-wrap gap-4 mb-6 pb-6 border-b border-theme">
        <div className="flex items-center gap-2 text-xs text-muted">
          ...
          <span className="font-medium">
            Créé: {new Date(procedure.createdDate).toLocaleDateString('fr-FR')}
          </span>
        </div>
        <div className="flex items-center gap-2 text-xs text-muted">
