...
export const procedures: Procedure[] = [
    {
        ...
        description: 'Guide professionnel ultra-complet pour installer, configurer et optimiser un serveur DHCP sur Windows Server 2019/2022. Inclut les bonnes pratiques, le dépannage et des exemples réels.',
        category: 'Réseau',
        content: proc1,
        tags: ['Windows Server', 'DHCP', 'Réseau', 'PowerShell', 'Active Directory', 'Infrastructure', 'Haute Disponibilité'],
    ...
    },
    {
        ...
        description: 'Procédure pour déployer une application React sur Vercel, Netlify ou GitHub Pages.',
    ...
    },
    {
        ...
        description: 'Guide pas à pas pour installer OpenProject sur Debian 12 (Bookworm), incluant la configuration du dépôt, l\'installation via APT et la configuration initiale.',
        category: 'Système',
        content: proc3,
    ...
    },
    {
        ...
        description: 'Procédure d\'installation de Zabbix Server 7.0 LTS avec base de données MariaDB sur Debian 12 (sans sudo).',
        category: 'Système',
        content: proc4,
    ...
    },
    {
        ...
        description: 'Procédure générique pour déployer l\'agent Zabbix sur un serveur Linux et le déclarer correctement dans l\'interface Zabbix.',
        category: 'Système',
        content: proc5,
    ...
    },
    {
        ...
        description: 'Guide complet pour la mise en place d\'un VPN MFA utilisant OpenVPN, PFSense et Duo Security pour une authentification forte.',
        category: 'Sécurité',
        content: proc6,
