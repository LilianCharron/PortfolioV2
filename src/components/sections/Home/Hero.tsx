          ...
          >
            <div className="space-y-4">
              ...
              >
                <Link
                  to="/cv"
                  className="hover:text-warning transition-colors flex items-center gap-6"
                >
            ...
            Je suis un étudiant passionné par le développement web et l'administration réseau. Capable de monter des serveurs et de créer des interfaces épurées, je mets mes compétences au service de projets concrets et performants.
            ...
            <div className="flex gap-8 pt-6">
              <SocialLink href="https://github.com" icon={<FaGithub />} playSound={playSound} />
              <SocialLink href="https://linkedin.com" icon={<FaLinkedin />} playSound={playSound} />
              <SocialLink href="mailto:contact@liliancharron.fr" icon={<FaEnvelope />} playSound={playSound} />
            </div>
          </motion.div>
            ...
            <div className="relative w-64 h-64 flex items-center justify-center">
              ...
              >
                <img
                  ...
                  alt="Lilian"
                  className="w-full h-full object-contain group-hover:scale-110 duration-700 transition-transform"
                />
...
const SocialLink = ({ href, icon, playSound }: { href: string; icon: React.ReactNode; playSound: any }) => (
  <motion.a
